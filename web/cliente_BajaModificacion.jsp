...
<html>
    <head>
        ...
        <title>Modificaci&oacute;n de Cliente</title>
        <%}%>        
        <!--CSS-->  
    ...
    <body class="w3-light-grey">   
        ...
        <div class="ABMContainer">
            ...
            <header class="w3-container estilosHeader">
                <%if (tipoJSP.equals("baja")) {%>
                <h5><b><i class="fa fa-address-card"></i> Baja de Cliente</b></h5>
                <%} else if (tipoJSP.equals("modificacion")) {%>
                <h5><b><i class="fa fa-address-card"></i> Modificaci&oacute;n de Cliente</b></h5>
                <%}%> 
            </header>
            <div class="form">
                <form>
                ...
                <!--NUMERO DE CLIENTE, EMAIL (CLIENTE), NOMBRE COMPLETO (PERSONA)-->
                    ...
                    <div id="tablaClientes" >
                        ...
                        <div class="margin-top20">
                            <div class="botonera">
                                <%if (tipoJSP.equals("baja")) {%>
                                <input type="button" class="submitBaja" onclick="borrarClientesSeleccionados()" id="btnBorrarClientesSeleccionados" value="Borrar">                                      
                                <%} 
                                else if (tipoJSP.equals("modificacion")) {%>
